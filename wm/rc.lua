...
globalkeys = my_table.join(
    ...
    function ()
        ...
        beautiful.bg_normal, beautiful.fg_normal, beautiful.tasklist_bg_focus, beautiful.tasklist_fg_item))
	end,
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( "rofi-theme-selector" ) end,
